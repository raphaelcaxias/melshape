...
class NutritionService:
    ...
    def calc_goal_calories(
        ...
        Args:
            ...
            custom_override: Meta customizada pelo profissional (Sprint 4).
                             Se preenchida, substitui completamente o cálculo.

        Returns:
            Meta calórica em kcal/dia
        """
        # Sprint 4 — meta personalizada pelo profissional tem prioridade
        if custom_override and custom_override > 0:
            logger.info(f"✅ Meta calórica customizada pelo profissional: {custom_override} kcal")
