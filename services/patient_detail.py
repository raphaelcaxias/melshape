...
from views.professional.patient_detail_tabs import _tab_score, _tab_conquistas
...
class PatientDetailRenderer:
    ...
    def _render_tabs(self) -> None:
        ...
        Resumo Pré-Consulta vem primeiro: é o diferencial real do produto
        (Auditoria Mestra) e a ação que o profissional mais precisa antes
        de uma consulta. Streamlit não permite abrir uma tab específica
        via código — a ordem é a forma de garantir destaque.
        """
        tab_resumo, tab_acoes, tab_peso, tab_nutri, tab_score, tab_conquistas = st.tabs([
            "📄 Resumo Pré-Consulta",
            "📋 Ações Clínicas",
            "⚖️ Evolução de Peso",
            "🍽️ Nutrição",
